...
order1Status.textContent =
  order1Root.dataset.delivered === "true" ? "Delivered" : "Pending";
...
order2Status.textContent =
  order2Root.dataset.delivered === "true" ? "Delivered" : "Pending";
...
order3Status.textContent =
  order3Root.dataset.delivered === "true" ? "Delivered" : "Pending";
